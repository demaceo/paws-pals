    ...
    <div className="bg-zinc-50 pb-20 pt-10 dark:bg-black">
      ...
      <section className="mx-auto max-w-7xl px-6 py-10">
        <div className="grid items-center gap-10 md:grid-cols-2">
          <div>
            <h1 className="text-4xl font-semibold tracking-tight text-zinc-950 sm:text-5xl dark:text-zinc-50">{m["hero.title"]}</h1>
            <p className="mt-4 max-w-xl text-lg leading-7 text-zinc-600 dark:text-zinc-400">{m["hero.subtitle"]}</p>
          ...
          <div className="rounded-3xl border border-black/5 bg-white p-6 shadow-sm dark:border-white/10 dark:bg-zinc-900">
            <dl className="grid grid-cols-3 gap-4 text-center">
              <div>
                <dt className="text-sm text-zinc-600 dark:text-zinc-400">{m["stats.dogs"]}</dt>
                <dd className="text-3xl font-semibold text-zinc-950 dark:text-zinc-50">{dogs.length}</dd>
              </div>
              <div>
                <dt className="text-sm text-zinc-600 dark:text-zinc-400">{m["stats.avgAge"]}</dt>
                <dd className="text-3xl font-semibold text-zinc-950 dark:text-zinc-50">2.7y</dd>
              </div>
              <div>
                <dt className="text-sm text-zinc-600 dark:text-zinc-400">{m["stats.goal"]}</dt>
      ...
      <section id="how-it-works" className="mx-auto max-w-7xl px-6 py-8">
        <h2 className="text-2xl font-semibold tracking-tight">{m["how.title"]}</h2>
        <p className="mt-2 max-w-2xl text-zinc-600 dark:text-zinc-400">{m["how.subtitle"]}</p>
        <ol className="mt-6 grid gap-4 sm:grid-cols-3">
          <li className="rounded-2xl border border-black/5 bg-white p-4 shadow-sm dark:border-white/10 dark:bg-zinc-900">
            ...
            <p className="mt-2 text-sm text-zinc-600 dark:text-zinc-400">{m["how.1.desc"]}</p>
          </li>
          <li className="rounded-2xl border border-black/5 bg-white p-4 shadow-sm dark:border-white/10 dark:bg-zinc-900">
            <div className="flex items-center gap-3">
            ...
            <p className="mt-2 text-sm text-zinc-600 dark:text-zinc-400">{m["how.2.desc"]}</p>
          </li>
          <li className="rounded-2xl border border-black/5 bg-white p-4 shadow-sm dark:border-white/10 dark:bg-zinc-900">
            <div className="flex items-center gap-3">
            ...
            <p className="mt-2 text-sm text-zinc-600 dark:text-zinc-400">{m["how.3.desc"]}</p>
          </li>
        </ol>
      </section>
